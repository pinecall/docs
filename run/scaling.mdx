---
title: "Scaling"
description: "What each process costs, where it saturates, and the numbers measured on this stack."
"og:see_also": "https://github.com/pinecall/runtime/docs/scaling.md"
---
...
[the-runtime-cli.md](/operate/the-runtime-cli); the box that runs all of this is
[../infra/box/README.md](https://github.com/pinecall/runtime/blob/main/docs/../infra/box/README.md); the per-cloud scripts are
[../infra/fleet/README.md](https://github.com/pinecall/runtime/blob/main/docs/../infra/fleet/README.md).
...
one after. With both workers cordoned, `POST /v1/tokens` answered the `503` above, `POST /v1/callbacks` took a number, and a dispatch into a room with a visitor in it was answered by the
