---
title: "Projections"
description: "The reductions the wire defines, shared by every language."
"og:see_also": "https://github.com/pinecall/protocol/docs/projections.md"
---
...
page is the contract every sink obeys, and the tests on both sides (`runtime/tests/log/ test_projection.py`, `typescript/test/projection.test.ts`) assert it over the golden state.
