---
title: "Pipeline"
description: "The six knobs an operator turns over what an agent hears, decides and speaks with."
"og:see_also": "https://github.com/pinecall/runtime/docs/protocol/pipeline-api.md"
---
Beside [operator-api.md](/api/operator) because they are the same public contract — everything
...
[settings-api.md](https://github.com/pinecall/runtime/blob/main/docs/protocol/settings-api.md). This door stays one release for the console's Pipeline screen:
