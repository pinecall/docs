---
title: "Call events"
description: "Everything that happens inside one call, in the order it happened."
"og:see_also": "https://github.com/pinecall/protocol/docs/events-call.md"
---
...
Data: `RealtimeModelMetrics`, in [metrics.md](/wire/metrics).
...
Data: `STTMetrics`, in [metrics.md](/wire/metrics).
...
Data: `TTSMetrics`, in [metrics.md](/wire/metrics).
...
Data: `VADMetrics`, in [metrics.md](/wire/metrics).
