---
title: "The fleet"
description: "More than one worker: what `fleet list` shows and what `cordon` does."
"og:see_also": "https://github.com/pinecall/runtime/infra/fleet/README.md"
---
...
and `make deploy`: the manifest enables `pinecall-fleet.service`, and `journalctl -u pinecall-fleet -f` is the loop, one line a tick. `instanceAdmin.v1` is create, delete, list and
