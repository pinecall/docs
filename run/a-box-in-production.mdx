---
title: "A box in production"
description: "One machine with a domain, from an operating system — with a screenshot of every screen."
"og:see_also": "https://github.com/pinecall/runtime/docs/a-box-in-production.md"
---
...
Writing a laptop's runtime instead? That is [from-zero.md](/start/from-zero), which is the same
...
about, and lets a person who forgot their password ask for a link themselves (`POST /v1/login/reset`). A box that cannot still works exactly as before: the link is in the answer, and
...
`PUT /v1/ops/mail` from the admin page ([the-box.md](/api/the-box)), which wins over the two
...
`production` switch an admin turns on in Team — and only when the request says so (`pinecall-env: production`; from a terminal, `pinecall start --prod`). What answers your customers is normally a
...
credential and `PINECALL_URL` to the gateway on loopback, and runs `pinecall start --prod ${PINECALL_AGENT:-}`: a `PINECALL_AGENT` in that `.env` names the agent file to run when the app's
...
Every verb, with its own outputs: [from-zero.md](/start/from-zero) and the agents repo's
`docs/the-cli.md`.
...
One row, in effect on the next call, carrier untouched. [protocol/numbers.md](/api/numbers)
...
none. [protocol/operator-api.md](/api/operator) is the door,
[protocol/console-api.md](/api/console) §4 the one that places the call.
...
<Frame>
  <img src="/images/light/agents.png" alt="Agents" className="block dark:hidden" />
  <img src="/images/dark/agents.png" alt="Agents" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/live.png" alt="Live" className="block dark:hidden" />
  <img src="/images/dark/live.png" alt="Live" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/sessions.png" alt="Sessions" className="block dark:hidden" />
  <img src="/images/dark/sessions.png" alt="Sessions" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/talk.png" alt="Talk" className="block dark:hidden" />
  <img src="/images/dark/talk.png" alt="Talk" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/chat.png" alt="Chat" className="block dark:hidden" />
  <img src="/images/dark/chat.png" alt="Chat" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/calls.png" alt="Calls" className="block dark:hidden" />
  <img src="/images/dark/calls.png" alt="Calls" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/pipeline.png" alt="Pipeline" className="block dark:hidden" />
  <img src="/images/dark/pipeline.png" alt="Pipeline" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/knowledge.png" alt="Knowledge" className="block dark:hidden" />
  <img src="/images/dark/knowledge.png" alt="Knowledge" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/memory.png" alt="Memory" className="block dark:hidden" />
  <img src="/images/dark/memory.png" alt="Memory" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/evals.png" alt="Evals" className="block dark:hidden" />
  <img src="/images/dark/evals.png" alt="Evals" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/numbers.png" alt="Numbers" className="block dark:hidden" />
  <img src="/images/dark/numbers.png" alt="Numbers" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/keys.png" alt="Keys" className="block dark:hidden" />
  <img src="/images/dark/keys.png" alt="Keys" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/providers.png" alt="Providers" className="block dark:hidden" />
  <img src="/images/dark/providers.png" alt="Providers" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/team.png" alt="Team" className="block dark:hidden" />
  <img src="/images/dark/team.png" alt="Team" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/usage.png" alt="Usage" className="block dark:hidden" />
  <img src="/images/dark/usage.png" alt="Usage" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/admin-orgs.png" alt="Orgs" className="block dark:hidden" />
  <img src="/images/dark/admin-orgs.png" alt="Orgs" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/admin-routes.png" alt="Routes" className="block dark:hidden" />
  <img src="/images/dark/admin-routes.png" alt="Routes" className="hidden dark:block" />
</Frame>

**Routes**: los números desde el lado del operador — qué org, qué agente, qué mundo.

<Frame>
  <img src="/images/light/admin-fleet.png" alt="Fleet" className="block dark:hidden" />
  <img src="/images/dark/admin-fleet.png" alt="Fleet" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/light/admin-usage.png" alt="Usage" className="block dark:hidden" />
  <img src="/images/dark/admin-usage.png" alt="Usage" className="hidden dark:block" />
</Frame>
