---
title: "Pipeline"
description: "What an agent hears, decides and speaks with, read as three legs and what they cost."
...
a version a row — at `PUT /v1/agents/{slug}/settings` ([settings-api.md](/api/settings)), applied
