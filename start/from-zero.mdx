...
sandbox, and the sandbox is watched on your own machine: `pinecall serve` — or `pinecall run --serve`, both in one terminal — puts the console on `http://localhost:4100`, forwarding every
