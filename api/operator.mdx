...
`{now, workers: [{worker, active, max_jobs, load, draining, cordoned, seen_at}], totals: {workers, active, seats, free, accepting, full, busy}}` — every worker ever heard from, stale ones included
